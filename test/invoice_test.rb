...
class InvoiceTest < Minitest::Test
  ...
  def test_when_it_was_updated
    ...
    assert_equal Time.parse("2009-06-19"), invoice[0].updated_at
    assert_equal Time.parse("2007-07-08"), invoice[1].updated_at
    assert_equal Time.parse("2007-10-21"), invoice[2].updated_at
  end
end
